...
| `min_coverage` | float | `0.25` | A segment is labelled only when at least this share of its span lies inside diarized speech. 0 to 1. |
| `min_speaker_share` | float | `0.6` | The winning speaker must hold at least this share of the segment's diarized speech; otherwise the segment stays unlabelled. 0 to 1. |
